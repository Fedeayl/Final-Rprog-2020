...
```{r, echo = TRUE}
R1 <- kbl(T1, caption = "Resultado por departamento. Elección nacional. Uruguay 2019" , 
...
La tabla que sigue resume el ganador por departamento y el margen de victoria. Es de notar que el Partido Nacional fue victorioso en `r sum(T2$Ganador=="Partido Nacional")` de los 19 departamentos, el Frente Amplio lo fue en `r sum(T2$Ganador=="Partido Frente Amplio")`, mientras que el Partido Colorado solamente en `r sum(T2$Ganador=="Partido Colorado")`
...
La respuesta es presentada en las tablas siguientes. 
...
Res_Hojas$Hoja[which.max(Res_Hojas$Cantidad_Deptos[Res_Hojas$Partido=="Partido Frente Amplio"])]
Res_Hojas$Cantidad_Deptos[which.max(Res_Hojas$Cantidad_Deptos[Res_Hojas$Partido=="Partido Frente Amplio"])]
```

Es de notar que en el caso del Frente Amplio, la hoja ganadora en más departamentos fue la `r Res_Hojas$Hoja[which.max(Res_Hojas$Cantidad_Deptos[Res_Hojas$Partido=="Partido Frente Amplio"])]` que ganó en `r Res_Hojas$Cantidad_Deptos[which.max(Res_Hojas$Cantidad_Deptos[Res_Hojas$Partido=="Partido Frente Amplio"])]` departamentos. En el caso del Partido Nacional, lo fue la hoja `r Res_Hojas$Hoja[which.max(Res_Hojas$Cantidad_Deptos[Res_Hojas$Partido=="Partido Nacional"])]` con `r Res_Hojas$Cantidad_Deptos[which.max(Res_Hojas$Cantidad_Deptos[Res_Hojas$Partido=="Partido Nacional"])]` departamentos a su favor, y la hoja colorada más victoriosa con  `r Res_Hojas$Cantidad_Deptos[which.max(Res_Hojas$Cantidad_Deptos[Res_Hojas$Partido=="Partido Colorado"])]` departamentos a su favor fue la `r Res_Hojas$Hoja[which.max(Res_Hojas$Cantidad_Deptos[Res_Hojas$Partido=="Partido Colorado"])]`.
...
El departamento en el que Cabildo Abierto obtuvo su mejor votación (como porcentaje del total de votos del departamento) fue `r ResCA$DEPTO[which.max(ResCA$porcentaje)]`
